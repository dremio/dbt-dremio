...
class TestGetCustomSchema:
    ...
    def test_custom_schema_table(self, project):
        ...
        table_relation = relation_from_name(project.adapter, "nested.schema.custom_schema_table")
    ...
    def test_custom_schema_view(self, project):
        ...
        view_relation = relation_from_name(project.adapter, "nested.schema.custom_schema_view")
        with get_connection(project.adapter):
